(defproject nagger "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {
    :builds [{:id "dev"
              ...
              :compiler {:main nagger.core
                         :asset-path "js/compiled/out"
                         :output-to "resources/public/js/compiled/nagger.js"
                         :output-dir "resources/public/js/compiled/out"
                         :source-map-timestamp true }}
             {:id "min"
              :source-paths ["src"]
              :compiler {:output-to "resources/public/js/compiled/nagger.js"
                         :main nagger.core
