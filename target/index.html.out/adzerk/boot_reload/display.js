...
return (function (p__8058){
var vec__8059 = p__8058;
var attr = cljs.core.nth.call(null,vec__8059,(0),null);
var v = cljs.core.nth.call(null,vec__8059,(1),null);
...
var args8060 = [];
var len__6146__auto___8063 = arguments.length;
var i__6147__auto___8064 = (0);
while(true){
if((i__6147__auto___8064 < len__6146__auto___8063)){
args8060.push((arguments[i__6147__auto___8064]));

var G__8065 = (i__6147__auto___8064 + (1));
i__6147__auto___8064 = G__8065;
continue;
} else {
}
break;
...
var len__6146__auto___8068 = arguments.length;
var i__6147__auto___8069 = (0);
while(true){
if((i__6147__auto___8069 < len__6146__auto___8068)){
args__6153__auto__.push((arguments[i__6147__auto___8069]));

var G__8070 = (i__6147__auto___8069 + (1));
i__6147__auto___8069 = G__8070;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8067){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8067));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8071){
var map__8075 = p__8071;
...
var data = map__8075__$1;
var message = cljs.core.get.call(null,map__8075__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8075__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8075__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8077 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8077,goog.events.EventType.CLICK,((function (G__8077,map__8075,map__8075__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8077,map__8075,map__8075__$1,data,message,line,file))
);

return G__8077;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8078){
var map__8082 = p__8078;
...
var data = map__8082__$1;
var message = cljs.core.get.call(null,map__8082__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8082__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8082__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
goog.events.listen(G__8084,goog.events.EventType.CLICK,((function (G__8084,map__8082,map__8082__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8084,map__8082,map__8082__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8085){
var map__8089 = p__8085;
...
var messages = map__8089__$1;
var warnings = cljs.core.get.call(null,map__8089__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8089__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8091 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8091,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8091,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8092){
var map__8095 = p__8092;
...
var messages = map__8095__$1;
var warnings = cljs.core.get.call(null,map__8095__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8095__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8095,map__8095__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8095,map__8095__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8095,map__8095__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8095,map__8095__$1,messages,warnings,exception))
;
...
if(no_prob_QMARK_){
return goog.Timer.callOnce(hide_BANG_,(adzerk.boot_reload.display.transition_duration * (3)));
} else {
return null;
}
});
...
adzerk.boot_reload.display.remove_container_BANG_.call(null,container);
} else {
}
