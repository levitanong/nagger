...
adzerk.boot_reload.client.handle = (function (){var method_table__6001__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"adzerk.boot-reload.client","handle"),((function (method_table__6001__auto__,prefer_table__6002__auto__,method_cache__6003__auto__,cached_hierarchy__6004__auto__,hierarchy__6005__auto__){
...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__7841,opts){
var map__7842 = p__7841;
var map__7842__$1 = ((((!((map__7842 == null)))?((((map__7842.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7842.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7842):map__7842);
var files = cljs.core.get.call(null,map__7842__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6146__auto___7848 = arguments.length;
var i__6147__auto___7849 = (0);
while(true){
if((i__6147__auto___7849 < len__6146__auto___7848)){
args__6153__auto__.push((arguments[i__6147__auto___7849]));

var G__7850 = (i__6147__auto___7849 + (1));
i__6147__auto___7849 = G__7850;
continue;
} else {
}
break;
...
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__6154__auto__);
});

adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__7846){
var vec__7847 = p__7846;
var opts = cljs.core.nth.call(null,vec__7847,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__7847,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__7847,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__7847,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__7847,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq7844){
var G__7845 = cljs.core.first.call(null,seq7844);
var seq7844__$1 = cljs.core.next.call(null,seq7844);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__7845,seq7844__$1);
});
